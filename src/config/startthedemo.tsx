...
export const items = [
  ...
  },
  {
    ...
    print:
      'Wenn ihr einen Transporter für die Demo gemietet habt, sollte auf jeden Fall klar sein, wer den Schlüssel aufbewahrt. Nicht, dass er im letzten Moment nicht mehr auffindbar ist.',
  },
  {
    active: false,
    ...
    print:
      'Viel Berichterstattung findet immer noch über normale Tageszeitungen und deren Portale statt. Insbesondere wenn ihr ältere und unbeteiligte Menschen von eurer Sache überzeugen wollt, solltet ihr auch klassische Medien kontaktieren, um eure Demo und euer Anliegen publik zu machen und zu erklären.',
  },
  {
    active: false,
    link: '',
  ...
  },
  {
    ...
    print: 'Um euren Protest auch an anderen Tagen öffentlich zu zeigen, könnt ihr T-Shirts (idealerweise aus Biobaumwolle) mit dem Demoslogan drucken lassen.',
  },
  {
    active: false,
    ...
    print:
      'Ein Megafon ist wichtig, z.B. um Sprechchöre anzustimmen. Als Ergänzung zu Lautsprechern und Mikrofon ist es auch mobiler einsetzbar, sobald sich die Demonstration in Bewegung setzt.',
  },
  {
    active: false,
    link: '',
  ...
  },
  {
    ...
    print:
      'Die beste Demo ist die, bei der gute Musik läuft und Lieder auch mal mitgesungen werden. Am besten bereitet ihr eine Playlist mit einer Mischung aus klassischen Protestliedern und neueren empowernden Songs zusammen.',
  },
  {
    active: false,
    link: '',
    ...
    print: 'Falls ihr Glück habt, kennt ihr jemanden, der Live-Musik auf der Demo spielen kann (oder als DJ auflegt).Vergesst den Soundcheck nicht!',
  },
  {
    active: false,
    link: '',
  ...
  },
  {
    ...
    print:
      'Wenn ihr z. B.einen Transporter mit offener Ladefläche als Bühne nutzen wollt, ist es dort praktisch, ein Mikrofon mit Lautsprecher zu haben. Gerade eure Redner:innen wollen gut von allen gehört werden. Testet am Besten vorab, wie gut die Qualität und die Lautstärke der Anlage ist.',
  },
  {
    active: false,
    link: '',
  ...
  },
  {
    ...
    print:
      'Eine Checklist kann euch helfen, alle zu organisierenden Dinge im Auge zu behalten. Dabei helfen euch auch bereits bestehende Checklists, wie z.B. diese von Aktion Mensch erstellte -> https://delivery-aktion-mensch.stylelabs.cloud/api/public/content/online-tipps-checklisten.pdf?v=639b5fef',
  },
  {
    active: false,
    link: '',
  ...
  },
  {
    ...
    print:
      'Die Anmeldebestätigung der Stadt ist wichtig, denn sie bestätigt, dass ihr eure Demo korrekt bei der Stadt angezeigt habt. Meist folgt darauf ein Vorgespräch mit der Polizei, bei dem Rahmenbedingungen und Auflagen geklärt werden.',
  },
  {
    active: false,
    link: 'posterparade',
    ...
    print: 'Manche Leute werden durch Plakate in ihrem Kiez auf eine Demo aufmerksam. Vergesst also nicht, auch im Analogen Werbung für eure Demo zu machen.',
  },
  {
    active: false,
    link: 'protestart',
    ...
    print: 'Keine Demo kommt ohne Plakate, Parolen und Transparente aus. Für die erste und sichtbarste Reihe empfiehlt es sich, ein großes Banner ("Transpi") drucken zu lassen.',
  },
  {
    active: false,
    ...
    print:
      'Je jünger eure Zielgruppe für die Demo, desto wichtiger ist Social Media. Wenn ihr sehr früh mit der Demoplanung angefangen habt, ist es gut, bereits einige Wochen vorher den Termin bekannt zu machen.',
  },
  {
    active: false,
    link: '',
    ...
    print:
      'Im Vorfeld braucht es viel Mobilisierung im Internet, z.B. über Social Media oder Mailinglisten. Letztere haben den Vorteil, dass sie meist über Verbände und Vereine weiter in die Strukturen durchgereicht werden und auch Leute erreichen, die nicht auf Social Media Kanälen unterwegs sind.',
  },
  {
    active: false,
    link: '',
    ...
    print:
      'Diesen Job macht keiner gern und auf vielen Demos werden noch spontan Ordner:innen gesucht. Idealerweise habt ihr bereits vor der Demo eine Reihe von Freiwilligen gefunden, die als Ordner:innen die Demo flankieren. Ordner:innen sollen vor allem die Demo-Auflagen durchsetzen, also z.B. eingreifen, wenn jemand aggressiv wird oder Gegenstände dabei hat, die untersagt sind.',
  },
  {
    active: false,
    link: '',
    ...
    print:
      'In den meisten Städten muss man Demonstrationen bis zu 48 Stunden vorher anmelden. In kurzfristigen Fällen funktioniert das aber auch auf telefonischem oder mündlichen Weg. Die Demoanmeldung ist daher ein wichtiger, wenn auch bürokratischer Akt.',
  },
]
